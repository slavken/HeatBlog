        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <a href="{{ route('categories.create') }}" class="btn btn-success mb-3">Add a category</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-0 rounded active">Categories</a>
