...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="card mb-4">
                    <div class="card-header">Create cache</div>

                    <div class="card-body">
                        <form action="{{ route('cache.store') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="name">Cache key</label>
                                <input type="text" class="form-control form-control-lg @error is-invalid @enderror" id="name" name="name" required autofocus>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="list-group">
                            ...
                            <a href="{{ url('admin/cache') }}" class="list-group-item list-group-item-action border-0 rounded active">Cache</a>
                            @can('roles')
